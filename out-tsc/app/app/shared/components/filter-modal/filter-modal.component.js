...
export class FilterModalComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: FilterModalComponent, selectors: [["app-filter-modal"]], inputs: { isOpen: "isOpen", title: "title", description: "description", applyText: "applyText", selectedPeriod: "selectedPeriod", selectedPeriodValue: "selectedPeriodValue", selectedStartDate: "selectedStartDate", selectedEndDate: "selectedEndDate" }, outputs: { modalClosed: "modalClosed", filtersApplied: "filtersApplied" }, features: [i0.ɵɵNgOnChangesFeature], decls: 2, vars: 9, consts: [[3, "closed", "primary", "isOpen", "title", "description", "primaryText", "primaryDisabled"], [3, "valueChange", "period", "periodValue", "startDate", "endDate"]], template: function FilterModalComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵadvance();
            i0.ɵɵproperty("period", ctx.selectedPeriod)("periodValue", ctx.selectedPeriodValue)("startDate", ctx.selectedStartDate)("endDate", ctx.selectedEndDate);
