...
function CreateTransactionPage_footer_36_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "footer", 34)(1, "span");
    i0.ɵɵtext(2, " Saldo estimado ");
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate1("S/ ", i0.ɵɵpipeBind2(5, 1, ctx_r0.projectedBalance, "1.2-2"), "");
} }
function CreateTransactionPage_app_custom_alert_53_Template(rf, ctx) { if (rf & 1) {
    const _r2 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "app-custom-alert", 35);
    i0.ɵɵlistener("onCancel", function CreateTransactionPage_app_custom_alert_53_Template_app_custom_alert_onCancel_0_listener() { i0.ɵɵrestoreView(_r2); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.showUnsavedAlert = false); })("onConfirm", function CreateTransactionPage_app_custom_alert_53_Template_app_custom_alert_onConfirm_0_listener() { i0.ɵɵrestoreView(_r2); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.leaveWithoutSaving()); });
    i0.ɵɵelementEnd();
} }
function CreateTransactionPage_app_custom_alert_54_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "app-custom-alert", 36);
    i0.ɵɵlistener("onConfirm", function CreateTransactionPage_app_custom_alert_54_Template_app_custom_alert_onConfirm_0_listener() { i0.ɵɵrestoreView(_r3); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.showLoadError = false); });
    i0.ɵɵelementEnd();
} }
function CreateTransactionPage_app_custom_alert_55_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "app-custom-alert", 37);
    i0.ɵɵlistener("onConfirm", function CreateTransactionPage_app_custom_alert_55_Template_app_custom_alert_onConfirm_0_listener() { i0.ɵɵrestoreView(_r4); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.showSaveError = false); });
    i0.ɵɵelementEnd();
} }
export class CreateTransactionPage {
    ...
    get projectedBalance() {
        if (!this.selectedAccount)
            return null;
        const currentBalance = Number(this.selectedAccount.amount) || 0;
    ...
    saveTransaction() {
        ...
        this.createTransactionsUseCase.execute(request).service({
            success: () => {
                this.isSaving = false;
                this.hasPendingChanges = false;
                void this.alertService.showAlert('Movimiento registrado', `Tu ${this.selectedType === 'gastos' ? 'gasto' : 'ingreso'} se guardó correctamente.`).then(() => this.navService.back());
            },
            failure: () => {
                this.isSaving = false;
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CreateTransactionPage, selectors: [["app-create-transaction"]], decls: 56, vars: 57, consts: [["title", "Nueva transacci\u00F3n", 3, "back", "showBack", "loading"], [1, "create-transaction-page", 3, "fullscreen"], [1, "transaction-form", 3, "ngSubmit"], [3, "modelChange", "options", "model"], ["aria-live", "polite", 1, "transaction-preview"], [1, "preview-header"], [1, "preview-type"], ["aria-hidden", "true"], [1, "preview-date"], [1, "preview-value"], [1, "preview-amount"], [1, "preview-meta"], [1, "preview-detail"], ["size", "sm", "variant", "soft", "aria-hidden", "true", 3, "icon", "color"], ["class", "preview-footer", 4, "ngIf"], ["title", "Monto", "appearance", "plain"], ["name", "amount", "ariaLabel", "Monto de la transacci\u00F3n", "placeholder", "0.00", "currencyCode", "PEN", "variant", "enhanced", "locale", "es-PE", 3, "ngModelChange", "ngModel", "maxDigits", "required"], ["title", "Programaci\u00F3n"], ["secondaryText", "Fecha del movimiento", "ariaLabel", "Cambiar la fecha de la transacci\u00F3n", "fallbackIcon", "assets/icon/calendar.svg", 3, "activated", "primaryText"], ["title", "Cuenta"], ["ariaLabel", "Seleccionar cuenta", "fallbackIcon", "assets/icon/wallet.svg", 3, "activated", "primaryText", "secondaryText", "items"], ["title", "Categor\u00EDa"], ["ariaLabel", "Seleccionar categor\u00EDa", "fallbackIcon", "assets/icon/category.svg", 3, "activated", "primaryText", "secondaryText", "items", "interactive"], ["title", "Nota (opcional)"], ["name", "description", "ariaLabel", "Nota de la transacci\u00F3n", "placeholder", "Ej. Almuerzo con el equipo", 3, "ngModelChange", "embedded", "multiline", "rows", "maxLength", "ngModel"], ["title", "Consejo FinVia", "symbol", "\u2728", 3, "message"], [1, "action-container"], ["type", "submit", 3, "text", "loading", "disabled"], ["title", "Elige la fecha", "description", "Selecciona cu\u00E1ndo ocurri\u00F3 este movimiento.", "applyText", "Aplicar fecha", "selectedPeriod", "custom", 3, "modalClosed", "filtersApplied", "isOpen", "singleDate", "selectedPeriodValue", "selectedStartDate", "selectedEndDate"], [3, "accountSelected", "modalClosed", "isOpen", "accounts", "selectionMode", "selectedAccount"], [3, "categorySelected", "modalClosed", "isOpen", "categories", "selectionMode", "selectedCategory"], ["header", "Cambios sin guardar", "message", "Has realizado cambios en la transacci\u00F3n. \u00BFDeseas salir sin guardar?", "cancelText", "Seguir editando", "confirmText", "Salir", 3, "onCancel", "onConfirm", 4, "ngIf"], ["header", "No se pudieron cargar los datos", "message", "No fue posible obtener tus cuentas o categor\u00EDas. Int\u00E9ntalo nuevamente.", "confirmText", "Aceptar", 3, "onConfirm", 4, "ngIf"], ["header", "No se pudo registrar", "message", "Ocurri\u00F3 un error al guardar la transacci\u00F3n. Revisa los datos e int\u00E9ntalo nuevamente.", "confirmText", "Aceptar", 3, "onConfirm", 4, "ngIf"], [1, "preview-footer"], ["header", "Cambios sin guardar", "message", "Has realizado cambios en la transacci\u00F3n. \u00BFDeseas salir sin guardar?", "cancelText", "Seguir editando", "confirmText", "Salir", 3, "onCancel", "onConfirm"], ["header", "No se pudieron cargar los datos", "message", "No fue posible obtener tus cuentas o categor\u00EDas. Int\u00E9ntalo nuevamente.", "confirmText", "Aceptar", 3, "onConfirm"], ["header", "No se pudo registrar", "message", "Ocurri\u00F3 un error al guardar la transacci\u00F3n. Revisa los datos e int\u00E9ntalo nuevamente.", "confirmText", "Aceptar", 3, "onConfirm"]], template: function CreateTransactionPage_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵelement(23, "app-item-icon", 13);
            ...
            i0.ɵɵelement(30, "app-item-icon", 13);
            i0.ɵɵelementStart(31, "span")(32, "small");
            i0.ɵɵtext(33, "Categor\u00EDa");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(34, "strong");
            i0.ɵɵtext(35);
            i0.ɵɵelementEnd()()()();
            i0.ɵɵtemplate(36, CreateTransactionPage_footer_36_Template, 6, 4, "footer", 14);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(37, "app-section-card", 15)(38, "app-amount-input", 16);
            i0.ɵɵtwoWayListener("ngModelChange", function CreateTransactionPage_Template_app_amount_input_ngModelChange_38_listener($event) { i0.ɵɵtwoWayBindingSet(ctx.amount, $event) || (ctx.amount = $event); return $event; });
            i0.ɵɵlistener("ngModelChange", function CreateTransactionPage_Template_app_amount_input_ngModelChange_38_listener() { return ctx.onFormChange(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(39, "app-section-card", 17)(40, "app-selection-summary", 18);
            i0.ɵɵlistener("activated", function CreateTransactionPage_Template_app_selection_summary_activated_40_listener() { return ctx.openPeriodModal(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(41, "app-section-card", 19)(42, "app-selection-summary", 20);
            i0.ɵɵlistener("activated", function CreateTransactionPage_Template_app_selection_summary_activated_42_listener() { return ctx.openAccountModal(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(43, "app-section-card", 21)(44, "app-selection-summary", 22);
            i0.ɵɵlistener("activated", function CreateTransactionPage_Template_app_selection_summary_activated_44_listener() { return ctx.openCategoryModal(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(45, "app-section-card", 23)(46, "app-text-field", 24);
            i0.ɵɵtwoWayListener("ngModelChange", function CreateTransactionPage_Template_app_text_field_ngModelChange_46_listener($event) { i0.ɵɵtwoWayBindingSet(ctx.description, $event) || (ctx.description = $event); return $event; });
            i0.ɵɵlistener("ngModelChange", function CreateTransactionPage_Template_app_text_field_ngModelChange_46_listener() { return ctx.onFormChange(); });
            i0.ɵɵelementEnd()();
            i0.ɵɵelement(47, "app-info-banner", 25);
            i0.ɵɵelementStart(48, "div", 26);
            i0.ɵɵelement(49, "app-button", 27);
            i0.ɵɵelementEnd()()();
            i0.ɵɵelementStart(50, "app-filter-modal", 28);
            i0.ɵɵlistener("modalClosed", function CreateTransactionPage_Template_app_filter_modal_modalClosed_50_listener() { return ctx.closePeriodModal(); })("filtersApplied", function CreateTransactionPage_Template_app_filter_modal_filtersApplied_50_listener($event) { return ctx.applyPeriod($event); });
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(51, "app-account-selector-modal", 29);
            i0.ɵɵlistener("accountSelected", function CreateTransactionPage_Template_app_account_selector_modal_accountSelected_51_listener($event) { return ctx.selectAccount($event); })("modalClosed", function CreateTransactionPage_Template_app_account_selector_modal_modalClosed_51_listener() { return ctx.closeAccountModal(); });
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(52, "app-category-selector-modal", 30);
            i0.ɵɵlistener("categorySelected", function CreateTransactionPage_Template_app_category_selector_modal_categorySelected_52_listener($event) { return ctx.selectCategory($event); })("modalClosed", function CreateTransactionPage_Template_app_category_selector_modal_modalClosed_52_listener() { return ctx.closeCategoryModal(); });
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(53, CreateTransactionPage_app_custom_alert_53_Template, 1, 0, "app-custom-alert", 31)(54, CreateTransactionPage_app_custom_alert_54_Template, 1, 0, "app-custom-alert", 32)(55, CreateTransactionPage_app_custom_alert_55_Template, 1, 0, "app-custom-alert", 33);
        } if (rf & 2) {
            i0.ɵɵadvance();
            ...
            i0.ɵɵadvance(6);
            i0.ɵɵtextInterpolate(ctx.selectedType === "gastos" ? "\u2212" : "+");
            i0.ɵɵadvance(2);
            i0.ɵɵtextInterpolate1("S/ ", i0.ɵɵpipeBind2(20, 54, ctx.amount || 0, "1.2-2"), "");
            i0.ɵɵadvance(4);
            ...
            i0.ɵɵadvance();
            i0.ɵɵproperty("ngIf", ctx.projectedBalance !== null);
            i0.ɵɵadvance(2);
        ...
        } }, dependencies: [CommonModule, i7.NgIf, i7.DecimalPipe, FormsModule, i8.ɵNgNoValidate, i8.NgControlStatus, i8.NgControlStatusGroup, i8.RequiredValidator, i8.NgModel, i8.NgForm, IonicModule, i9.IonContent, i9.IonHeader, AccountSelectorModalComponent,
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CreateTransactionPage, { className: "CreateTransactionPage", filePath: "src/app/features/side-menu/transactions/create-transaction/create-transaction.page.ts", lineNumber: 68 }); })();
