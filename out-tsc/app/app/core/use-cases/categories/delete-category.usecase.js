...
export class DeleteCategoryUseCase {
    ...
    static { this.ɵfac = function DeleteCategoryUseCase_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || DeleteCategoryUseCase)(i0.ɵɵinject(i1.ApiService), i0.ɵɵinject(i2.EncryptionService)); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: DeleteCategoryUseCase, factory: DeleteCategoryUseCase.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DeleteCategoryUseCase, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
