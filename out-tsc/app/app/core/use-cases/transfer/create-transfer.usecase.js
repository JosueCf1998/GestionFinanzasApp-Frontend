...
export class CreateTransferUseCase {
    ...
    static { this.ɵfac = function CreateTransferUseCase_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || CreateTransferUseCase)(i0.ɵɵinject(i1.ApiService), i0.ɵɵinject(i2.EncryptionService)); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: CreateTransferUseCase, factory: CreateTransferUseCase.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CreateTransferUseCase, [{
        type: Injectable,
        args: [{
                providedIn: 'root',
            }]
    }], () => [{ type: i1.ApiService }, { type: i2.EncryptionService }], null); })();
//# sourceMappingURL=create-transfer.usecase.js.map